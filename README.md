...
- تصدير النتائج وتقارير PDF عربية عبر **WeasyPrint** مع الخط المحلي `assets/Cairo.ttf.b64` وترخيصه `assets/OFL-Cairo.txt`؛ لا حاجة إلى طلب خط من Google Fonts أثناء التشغيل.
...
الخط محفوظ في المستودع بترميز Base64 في `assets/Cairo.ttf.b64` لنقله عبر أدوات الملفات النصية دون تغيير بايتاته. يفك التطبيق الترميز داخل الذاكرة ويتحقق من SHA-256 الثابت، دون طلب شبكة أو كتابة بيانات العملاء إلى القرص. يعمل بنفس الخط على Community Cloud. ينشئ Docker نسخة خط عامة في `static/Cairo.ttf`؛ لا تضع بيانات أو أسراراً في static لأن محتواه غير محمي ببوابة OIDC. راجع [توثيق Streamlit](https://docs.streamlit.io/develop/concepts/configuration/serving-static-files).
